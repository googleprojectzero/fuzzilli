...
extension FuzzEngine {
    public func execute(_ program: Program, stats: inout ProgramGeneratorStats) -> ExecutionOutcome {
        ...
        if fuzzer.config.enableDiagnostics {
            ...
            ensureDeterministicExecutionBehaviourDiagnostic(of: program, firstExecution: execution)
        }
    ...
    private func ensureDeterministicExecutionBehaviourDiagnostic(of program: Program, firstExecution execution1: Execution) {
