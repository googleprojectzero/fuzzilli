...
public struct Fuzzilli_Protobuf_Instruction: Sendable {
  ...
  public var loopLabelBreak: Fuzzilli_Protobuf_LoopLabelBreak {
    get {
      if case .loopLabelBreak(let v)? = operation {return v}
  ...
  public var loopLabelContinue: Fuzzilli_Protobuf_LoopLabelContinue {
    get {
      if case .loopLabelContinue(let v)? = operation {return v}
  ...
  public var loadLabel: Fuzzilli_Protobuf_LoadLabel {
    get {
      if case .loadLabel(let v)? = operation {return v}
...
extension Fuzzilli_Protobuf_Instruction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    158: .same(proto: "loopLabelBreak"),
    159: .same(proto: "loopLabelContinue"),
    160: .same(proto: "loadLabel"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 158: try {
        var v: Fuzzilli_Protobuf_LoopLabelBreak?
        var hadOneofValue = false
        if let current = self.operation {
          hadOneofValue = true
          if case .loopLabelBreak(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.operation = .loopLabelBreak(v)
        }
      }()
      case 159: try {
        var v: Fuzzilli_Protobuf_LoopLabelContinue?
        var hadOneofValue = false
        if let current = self.operation {
          hadOneofValue = true
          if case .loopLabelContinue(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.operation = .loopLabelContinue(v)
        }
      }()
      case 160: try {
        var v: Fuzzilli_Protobuf_LoadLabel?
        var hadOneofValue = false
        if let current = self.operation {
          hadOneofValue = true
          if case .loadLabel(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.operation = .loadLabel(v)
        }
      }()
      case 161: try {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .loopLabelBreak?: try {
      guard case .loopLabelBreak(let v)? = self.operation else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 158)
    }()
    case .loopLabelContinue?: try {
      guard case .loopLabelContinue(let v)? = self.operation else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 159)
    }()
    case .loadLabel?: try {
      guard case .loadLabel(let v)? = self.operation else { preconditionFailure() }
