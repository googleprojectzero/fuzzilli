...
public struct Fuzzilli_Protobuf_Instruction: Sendable {
  ...
  public var beginForOfLoopWithObjectDestruct: Fuzzilli_Protobuf_BeginForOfLoopWithObjectDestruct {
    get {
      if case .beginForOfLoopWithObjectDestruct(let v)? = operation {return v}
      return Fuzzilli_Protobuf_BeginForOfLoopWithObjectDestruct()
    }
    set {operation = .beginForOfLoopWithObjectDestruct(newValue)}
  }

  public var beginForAwaitOfLoopWithObjectDestruct: Fuzzilli_Protobuf_BeginForAwaitOfLoopWithObjectDestruct {
    get {
      if case .beginForAwaitOfLoopWithObjectDestruct(let v)? = operation {return v}
      return Fuzzilli_Protobuf_BeginForAwaitOfLoopWithObjectDestruct()
    }
    set {operation = .beginForAwaitOfLoopWithObjectDestruct(newValue)}
  }
  ...
  public enum OneOf_Operation: Equatable, Sendable {
    ...
    case beginForOfLoopWithObjectDestruct(Fuzzilli_Protobuf_BeginForOfLoopWithObjectDestruct)
    case beginForAwaitOfLoopWithObjectDestruct(Fuzzilli_Protobuf_BeginForAwaitOfLoopWithObjectDestruct)
...
extension Fuzzilli_Protobuf_Instruction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 353: try {
        var v: Fuzzilli_Protobuf_BeginForOfLoopWithObjectDestruct?
        var hadOneofValue = false
        if let current = self.operation {
          hadOneofValue = true
          if case .beginForOfLoopWithObjectDestruct(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.operation = .beginForOfLoopWithObjectDestruct(v)
        }
      }()
      case 354: try {
        var v: Fuzzilli_Protobuf_BeginForAwaitOfLoopWithObjectDestruct?
        var hadOneofValue = false
        if let current = self.operation {
          hadOneofValue = true
          if case .beginForAwaitOfLoopWithObjectDestruct(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.operation = .beginForAwaitOfLoopWithObjectDestruct(v)
        }
      }()
      case 355: try {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .beginForOfLoopWithObjectDestruct?: try {
      guard case .beginForOfLoopWithObjectDestruct(let v)? = self.operation else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 353)
    }()
    case .beginForAwaitOfLoopWithObjectDestruct?: try {
      guard case .beginForAwaitOfLoopWithObjectDestruct(let v)? = self.operation else { preconditionFailure() }
