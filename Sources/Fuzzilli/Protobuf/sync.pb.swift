...
public struct Fuzzilli_Protobuf_FuzzerStateWithFastSync {
  ...
  public var compiledSeeds: Data = Data()
...
public struct Fuzzilli_Protobuf_MABState {
  ...
  public var codeGenWeights: [Fuzzilli_Protobuf_WeightedAction] = []

  public var programActions: [Fuzzilli_Protobuf_ProgramWeightedAction] = []

  public var seedActions: [Fuzzilli_Protobuf_ProgramWeightedAction] = []
...
public struct Fuzzilli_Protobuf_ProgramWeightedAction {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Fuzzilli_Protobuf_FuzzerStateWithFastSync: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "corpus"),
    2: .same(proto: "compiledSeeds"),
    3: .same(proto: "evaluatorState"),
    4: .same(proto: "mabState"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularBytesField(value: &self.compiledSeeds) }()
      case 3: try { try decoder.decodeSingularBytesField(value: &self.evaluatorState) }()
      case 4: try { try decoder.decodeSingularMessageField(value: &self._mabState) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.compiledSeeds.isEmpty {
      try visitor.visitSingularBytesField(value: self.compiledSeeds, fieldNumber: 2)
    }
    if !self.evaluatorState.isEmpty {
      try visitor.visitSingularBytesField(value: self.evaluatorState, fieldNumber: 3)
    }
  ...
  public static func ==(lhs: Fuzzilli_Protobuf_FuzzerStateWithFastSync, rhs: Fuzzilli_Protobuf_FuzzerStateWithFastSync) -> Bool {
    ...
    if lhs.compiledSeeds != rhs.compiledSeeds {return false}
...
extension Fuzzilli_Protobuf_MABState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    2: .same(proto: "codeGenWeights"),
    3: .same(proto: "programActions"),
    4: .same(proto: "seedActions"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeRepeatedMessageField(value: &self.codeGenWeights) }()
      case 3: try { try decoder.decodeRepeatedMessageField(value: &self.programActions) }()
      case 4: try { try decoder.decodeRepeatedMessageField(value: &self.seedActions) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.codeGenWeights.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.codeGenWeights, fieldNumber: 2)
    }
    if !self.programActions.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.programActions, fieldNumber: 3)
    }
    if !self.seedActions.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.seedActions, fieldNumber: 4)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: Fuzzilli_Protobuf_MABState, rhs: Fuzzilli_Protobuf_MABState) -> Bool {
    ...
    if lhs.codeGenWeights != rhs.codeGenWeights {return false}
    if lhs.programActions != rhs.programActions {return false}
    if lhs.seedActions != rhs.seedActions {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Fuzzilli_Protobuf_ProgramWeightedAction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ProgramWeightedAction"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "index"),
    2: .same(proto: "weight"),
    3: .same(proto: "age"),
  ...
  public static func ==(lhs: Fuzzilli_Protobuf_ProgramWeightedAction, rhs: Fuzzilli_Protobuf_ProgramWeightedAction) -> Bool {
