...
public struct Compiler_Protobuf_VariableDeclarator: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Compiler_Protobuf_ForInLoop: @unchecked Sendable {
  ...
  public var variableDeclaration: Compiler_Protobuf_VariableDeclaration {
    get {
      if case .variableDeclaration(let v)? = _storage._left {return v}
      return Compiler_Protobuf_VariableDeclaration()
    }
    set {_uniqueStorage()._left = .variableDeclaration(newValue)}
  }
...
extension Compiler_Protobuf_ForInLoop: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "variableDeclaration"),
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 1: try {
          ...
          if let v = v {
            if hadOneofValue {try decoder.handleConflictingOneOf()}
            _storage._left = .variableDeclaration(v)
          }
        }()
        case 2: try {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      case .variableDeclaration?: try {
        guard case .variableDeclaration(let v)? = _storage._left else { preconditionFailure() }
        try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
      }()
      case .identifier?: try {
