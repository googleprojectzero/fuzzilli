...
public struct Compiler_Protobuf_Parameter: Sendable {
  ...
  public var parameter: Compiler_Protobuf_Parameter.OneOf_Parameter? = nil

  public var identifierParameter: Compiler_Protobuf_IdentifierParameter {
    get {
      if case .identifierParameter(let v)? = parameter {return v}
      return Compiler_Protobuf_IdentifierParameter()
    }
    set {parameter = .identifierParameter(newValue)}
  }

  public var objectParameter: Compiler_Protobuf_ObjectParameter {
    get {
      if case .objectParameter(let v)? = parameter {return v}
  ...
  public var arrayParameter: Compiler_Protobuf_ArrayParameter {
    ...
    set {parameter = .arrayParameter(newValue)}
  }
...
extension Compiler_Protobuf_Parameter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try {
        ...
        if let v = v {
          ...
          self.parameter = .identifierParameter(v)
        }
      }()
      case 2: try {
        ...
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.parameter = .objectParameter(v)
        }
      }()
      case 3: try {
        ...
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.parameter = .arrayParameter(v)
        }
      }()
      default: break
      }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .identifierParameter?: try {
      guard case .identifierParameter(let v)? = self.parameter else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    }()
    case .objectParameter?: try {
      guard case .objectParameter(let v)? = self.parameter else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    }()
    case .arrayParameter?: try {
      guard case .arrayParameter(let v)? = self.parameter else { preconditionFailure() }
