...
public let AssignmentExpression    = ExpressionType(precedence: 3, associativity: .right,  characteristic: .effectful)
public let ArrowFunctionExpression = ExpressionType(precedence: 3, associativity: .right,  characteristic: .effectful)
