...
public let codeGeneratorWeights = [
    ...
    "PrototypeDeleteGenerator":                 10,
    "PrototypeFieldAccessGenerator":            10,
    "PrototypeFieldOverwriteGenerator":         5,
    "PrototypeFieldDeleteGenerator":            10,
    "PrototypeClassAccessGenerator":            10,
    "PrototypeClassSetGenerator":               10,
    "PrototypeClassDeleteGenerator":            10,
    "PrototypeFieldClassAccessGenerator":       10,
    "PrototypeFieldClassSetGenerator":          5,
    "PrototypeFieldClassDeleteGenerator":       10,
