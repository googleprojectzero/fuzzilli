...
public struct Context: OptionSet {
    ...
    // Inside a Class constructor definition
    public static let classConstructorDefinition = Context(rawValue: 1 << 7)
    // Inside a Class method definition
    public static let classMethodDefinition      = Context(rawValue: 1 << 8)
    // Inside a switch block
    public static let switchCase                 = Context(rawValue: 1 << 9)
    // Inside Object definition
    public static let objectDefinition           = Context(rawValue: 1 << 10)
    // Inside Object method definition
    public static let objectMethodDefinition     = Context(rawValue: 1 << 11)
