...
enum Opcode {
    ...
    case loadPrivateProperty(LoadPrivateProperty)
    case storePrivateProperty(StorePrivateProperty)
    case storePrivatePropertyWithBinop(StorePrivatePropertyWithBinop)
