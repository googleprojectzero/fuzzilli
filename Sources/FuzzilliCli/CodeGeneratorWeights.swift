...
let codeGeneratorWeights = [
    ...
    "BuiltinGenerator":                                 5,
    "ObjectGenerator":                                  20,
    "LoadCurrentObjectProperty":                        10,
    "StoreCurrentObjectProperty":                       10,
    "ArrayGenerator":                                   10,
    ...
    "SuperMethodCallWithSpreadGenerator":               10,
    "LoadSuperPropertyGenerator":                       10,
    "LoadSuperComputedPropertyGenerator":               10,
    "StoreSuperPropertyGenerator":                      10,
    "StoreSuperPropertyWithBinopGenerator":             10,
    "StoreSuperComputedPropertyGenerator":              10,
    "StoreSuperComputedPropertyWithBinopGenerator":     10,
    "InstanceMethodCallGenerator":                      10,
    "InstanceMethodCallWithSpreadGenerator":            5,
    "LoadInstancePropertyGenerator":                    10,
    "StoreInstancePropertyGenerator":                   10,
    "StoreInstancePropertyWithBinopGenerator":          10,
    "StoreInstanceComputedPropertyGenerator":           10,
    "IfElseGenerator":                                  25,
