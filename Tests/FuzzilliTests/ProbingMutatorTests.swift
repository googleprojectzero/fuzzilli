...
@Suite struct ProbingMutatorTests {
    @Test func testProbingMutatorBasic() {
        ...
        fuzzer.sync {
            ...
            // const v0 = {};
            // v0.bar = ...;
            #expect(lifted.contains("bar"))
        }
    }

    @Test func testProbingMutatorForBundle() {
        let runner = MockScriptRunner()
        ...
        fuzzer.sync {
            ...
            #expect(mutator.mutate(program, using: b, for: fuzzer) == nil)
        }
    }
}
