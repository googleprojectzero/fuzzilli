...
class TypeSystemTests: XCTestCase {
    ...
    func testWasmTypeExtensionSubsumptionRules() {
        ...
        XCTAssertFalse(ILType.wasmRef(.Index, nullability: true, description: arrayi32Desc)
            >= ILType.wasmRef(.Index, nullability: true, description: arrayi64Desc))
        XCTAssertFalse(ILType.wasmRef(.Index, nullability: true, description: arrayi64Desc)
            >= ILType.wasmRef(.Index, nullability: true, description: arrayi32Desc))
        XCTAssert(ILType.wasmRef(.Index, nullability: true, description: arrayi32Desc)
            >= ILType.wasmRef(.Index, nullability: true, description: arrayi32Desc))
        XCTAssert(ILType.wasmRef(.Index, nullability: true, description: arrayi32Desc)
            >= ILType.wasmRef(.Index, nullability: false, description: arrayi32Desc))
        XCTAssert(ILType.wasmRef(.Index, nullability: true) >= ILType.wasmRef(.Index, nullability: true, description: arrayi32Desc))
        XCTAssertFalse(ILType.wasmRef(.Index, nullability: true) <= ILType.wasmRef(.Index, nullability: true, description: arrayi32Desc))
