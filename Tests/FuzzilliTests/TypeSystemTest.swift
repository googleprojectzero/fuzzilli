...
class TypeSystemTests: XCTestCase {
    ...
    func testWasmSubsumptionRules() {
        let wasmTypes: [ILType] = [.wasmi32, .wasmi64, .wasmf32, .wasmf64] + ILType.allWasmRefTypes()
    ...
    func testWasmAbstractHeapTypeSubsumptionRules() {
        ...
        for shared in [true, false] {
            ...
            // is "broken". However, we will still need to allow this union type 
