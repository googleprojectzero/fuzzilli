...
class TypeSystemTests: XCTestCase {
    ...
    func testWasmTypeExtensionSubsumptionRules() {
        ...
        XCTAssertFalse(ILType.wasmRef(.Index(arrayi32Desc), nullability: true)
            >= ILType.wasmRef(.Index(arrayi64Desc), nullability: true))
        XCTAssertFalse(ILType.wasmRef(.Index(arrayi64Desc), nullability: true)
            >= ILType.wasmRef(.Index(arrayi32Desc), nullability: true))
        XCTAssert(ILType.wasmRef(.Index(arrayi32Desc), nullability: true)
            >= ILType.wasmRef(.Index(arrayi32Desc), nullability: true))
        XCTAssert(ILType.wasmRef(.Index(arrayi32Desc), nullability: true)
            >= ILType.wasmRef(.Index(arrayi32Desc), nullability: false))
        XCTAssert(ILType.wasmRef(.Index(), nullability: true) >= ILType.wasmRef(.Index(arrayi32Desc), nullability: true))
        XCTAssertFalse(ILType.wasmRef(.Index(), nullability: true) <= ILType.wasmRef(.Index(arrayi32Desc), nullability: true))
