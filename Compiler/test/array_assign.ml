...
let correct = 
    ...
    let store_comp_inst = build_store_computed_prop array_temp add_res_temp int30_temp builder in
    let res = [load_int_12; load_array; load_int_10; load_int_20; add_inst; load_int_30; store_comp_inst] in
